...
#define STRING_CONFIG_H_AUTHOR "(Silenoz_93, Anycubic i3 Mega)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 200, 6, 60 }
...
#define MIN_PROBE_EDGE 20 // Wie weit vom Rand
